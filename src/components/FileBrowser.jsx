...
import { FolderOpen, FileText, ChevronRight, ChevronDown, CheckCircle } from 'lucide-react';

export default function FileBrowser({ originalFiles, translatedFiles, onSelectFile, selectedFile, onSelectDirectory, sidebarWidth }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-4">
        {originalFiles.length === 0 && translatedFiles.length === 0 ? (
